...
"1 Right Oil Cooling / Coolant Fan",
	...
	},
	{
		...
		/* crank neg goes to https://gerefi.com/docs/pinouts/stim/?connector=main&pin=24C 2.5v source, crank positive 22B with a 4.7K pull up */
 ...
 "C8 - Idle",
	...
	// https://github.com/gerefi/gerefi/wiki/Hellen-154-Hyundai
	{
		...
		// https://github.com/gerefi/hellen154hyundai/issues/120
...
static bool doTestEcuDigitalOutput(int testLineIndex, bool isLowSide, CanRequestSender sender, bool expectation) {
	...
	for (int i = 0; i < cycleCount
	 ...
	 ; i++) {
        ...
        // see also https://github.com/gerefi/gerefi-hardware/issues/252
